...
def get_cost(task):
    ...
    if task[2] == 'Аналитическая геометрия' and task[3] == 'кр':
        return 100
    if task[2] == 'Кратные и криволинейные интегралы, ряды' and task[3] == 'дз2ч1':
        ...
        if task[4] in ['Восстановление функции по ее полному дифференциалу с помощью криволинейного интеграла 2-го рода',
            ...
            return 75
        return 100
    if task[2] == 'Кратные и криволинейные интегралы, ряды' and task[3] == 'дз2ч2':
        if task[4] in ['Нахождение области сходимости степенного ряда',
            ...
            return 75
        return 100
    if task[2] == 'Кратные и криволинейные интегралы, ряды' and task[3] == 'рк1':
        if task[4] == 'теория':
            return 175
        return 75
    if task[2] == 'Кратные и криволинейные интегралы, ряды' and task[3] == 'рк2':
