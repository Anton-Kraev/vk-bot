            ...
            if event.to_me:
                ...
                if user_id not in history.keys() or not history[user_id]:
                    ...
                    send_message(user_id, '***************\n' +
                                 'Привет, у нас ты можешь получить ответы, на интересующие тебя дисциплины в NOMOTEX\n'
                                 'Если бот не нашёл интересующую дисциплину/задание или возникли какие-либо трудности, '
                                 'можно обратиться к администратору сообщества: https://vk.com/id756717774 \n'
                                 'Также хотим уточнить, что лучше оплачивать задание с qiwi кошелька или карты "мир",'
                                 'т.к. при оплате с "visa" или "mastercard" может быть повышенная комиссия\n'
                                 '***************\n')
